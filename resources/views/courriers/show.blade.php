            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <a href="{{ route('courriers.edit', $courrier) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                            Modifier
                        </a>
                    </div>
                </div>
